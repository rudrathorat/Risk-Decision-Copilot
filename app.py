"""
Risk Decision Copilot — Streamlit UI
...
st.set_page_config(page_title="Risk Decision Copilot", layout="wide")
st.title("Risk Decision Copilot")
...
if st.button("Run Credit Analysis", type="primary"):
    ...
    st.divider()
    st.caption(f"Credit report for a **{currency} {loan_amount:,.0f}** loan over **{duration} months** — generated by Risk Decision Copilot.")
