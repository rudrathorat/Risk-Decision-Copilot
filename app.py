"""
Risk Decisioning Copilot — Streamlit UI
...
st.set_page_config(page_title="Risk Decisioning Copilot", layout="wide")
st.title("Risk Decisioning Copilot")
...
if st.button("Run Credit Analysis", type="primary"):
    ...
    st.divider()
    st.caption(f"Credit report for a **{currency} {loan_amount:,.0f}** loan over **{duration} months** — generated by Risk Decisioning Copilot.")
